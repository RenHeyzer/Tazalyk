...
import dev.renheyzer.tazalyk.components.signin.RealLoginComponent
...
class DefaultRootComponent(
    ...
    private fun createChild(
        ...
        Config.Login -> RootComponent.Child.SignIn(login(componentContext))
        Config.SignUp -> RootComponent.Child.SignUp(signUp(componentContext))
        is Config.Confirm -> RootComponent.Child.Confirm(confirm(componentContext, config))
        Config.CreatePassword -> RootComponent.Child.CreatePassword(createPassword(componentContext))
    }
