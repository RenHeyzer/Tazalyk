...
fun LoginScreen(
    ...
    var inputValue by remember { mutableStateOf(TextFieldValue(uiState.inputValue)) }
    ...
    Column(
        ...
        TazalykButton(
            ...
            enabled = uiState.inputValue.isNotBlank() && uiState.password.isNotBlank()
        ) {
        ...
        Text(
            ...
            modifier = Modifier.clickable { component.onSignUpClick() },
            color = TazalykTheme.colors.secondaryText,
            style = TazalykTheme.typography.body,
            textAlign = TextAlign.Center,
            textDecoration = TextDecoration.Underline
